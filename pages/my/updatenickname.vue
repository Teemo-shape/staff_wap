<template>
  <div class="form_content">
    ...
    <div class="form">
      <div class="form_item">
        <input type="text" class="ipt_txt" v-model="userinfo.nickName" placeholder="请输入昵称">
      </div>
  ...
  export default{
    ...
    methods:{
      ...
      saveForm(){
          ...
          if(this.userinfo.nickName.length>20||this.userinfo.nickName.length<4){
            this.$dialog.toast({
              mes: '昵称需4-20个字符',
              timeout: 1500,
              icon: 'error'});
